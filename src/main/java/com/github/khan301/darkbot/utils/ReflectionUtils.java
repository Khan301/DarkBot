...
public class ReflectionUtils {
    ...
    public static Class<?> compileModule(File original) throws Exception {
        ...
        try (StandardJavaFileManager fileManager = compiler.getStandardFileManager(diagnostics, null, null)) {
            File source = new File("tmp/com/github/khan301/darkbot/modules/" + original.getName());
            ...
            if (compiler.getTask(null, fileManager, diagnostics, optionList, null, fileManager.getJavaFileObjects(source)).call()) {
                ...
                Class<?> module = classLoader.loadClass("com.github.khan301.darkbot.modules." + moduleName);

                File moduleFolder = new File("tmp/com/github/khan301/darkbot/modules/");
                ...
                for (File file : subclasses) {
                    classLoader.loadClass("com.github.khan301.darkbot.modules." + file.getName().replace(".class", ""));
                }
